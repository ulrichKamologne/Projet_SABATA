...
class Map():
    ...
    def __init__ (self, new_map: str, new_appearance_mode: str):
...
class App(customtkinter.CTk):
    ...
    def tamplet (self):
        ...
        self.button_menu = customtkinter.CTkButton(self.my_frame_haut, text="", image=self.photo_mode, width=25,
                                                   height=25,
                                                   fg_color="#000000",
        ...
        self.button_retour = customtkinter.CTkButton(self.my_frame_haut, text="", width=25, height=25,
                                                     ...
                                                     text_color="#868282", command=self.menu)
        self.button_mode = customtkinter.CTkButton(self.my_frame_haut, text="", width=25, height=25,
    ...
    def option_2 (self):
        ...
        self.Conteneur = customtkinter.CTkFrame(master=self, corner_radius=0, fg_color=None)
        self.Conteneur.grid(row=1, column=0, padx=0, sticky="nsew")
        ...
        self.frame_left = customtkinter.CTkFrame(master=self.Conteneur, width=150, corner_radius=0, fg_color='#C9CBCA')
        ...
        self.frame_right.grid_rowconfigure(4, weight=0)
